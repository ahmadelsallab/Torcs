...
drive(int index, tCarElt* car, tSituation *s)
{
    ...
    /*********** Add image to the state string *******************/
//    std::string img = impipe.send_image(index);

//    stateString += SimpleParser::stringify("image", img);
//    ostringstream img_str;
//    img_str << "(" << "image" << " " << img << ")";
//    stateString += img_str.str();
